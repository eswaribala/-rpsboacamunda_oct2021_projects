 ...
 *//**
	 ...
	 *//*
		 * @Component("decisionlogger") public class DecisionDelegate implements
		 * JavaDelegate {
		 * 
		 * private final Logger LOGGER =
		 * Logger.getLogger(DecisionDelegate.class.getName());
		 * 
		 * public void execute(DelegateExecution execution) throws Exception {
		 * 
		 * LOGGER.info("\n\n  ... Decision Delegate invoked by " + "activityName='" +
